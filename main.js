...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ domSetForecast)
/* harmony export */ });
...
const daysOfTheWeek = document.querySelector('.days-of-week');
...
function populateHead() {
  forecastHeading.textContent = capitalizeText(forecast.todaysForeCast.weather[0].description);
  cityHeading.textContent = capitalizeText(forecast.todaysForeCast.name);
  ...
  temperatureHeading.textContent = `${Math.floor(forecast.todaysForeCast.main.temp)} \u00B0F`;
  weatherIconHeading.innerHTML = getIcon(forecast.todaysForeCast.weather[0].icon);
  detailsFeelsLike.textContent = `${Math.floor(forecast.todaysForeCast.main.feels_like)} \u00B0F`;
  detailsHumidity.textContent = `${forecast.todaysForeCast.main.humidity}%`;
  detailsWindSpeed.textContent = `${forecast.todaysForeCast.wind.speed} mph`;
}
...
/* harmony import */ var _images_search_icon_png__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./images/search-icon.png */ "./src/images/search-icon.png");
/* eslint linebreak-style: ["error", "windows"] */
...
searchIcon.src = _images_search_icon_png__WEBPACK_IMPORTED_MODULE_3__;
searchIcon.setAttribute('id', 'search-icon');
searchForm.append(searchIcon);

async function makeCall(input) {
  const inputFormatted = (0,_modules_apiFunctionality__WEBPACK_IMPORTED_MODULE_1__.formatCity)(input);
  const foreCast = await (0,_modules_apiFunctionality__WEBPACK_IMPORTED_MODULE_1__.foreCastRequest)(inputFormatted);
  return foreCast;
}

makeCall('Salt Lake City, Utah').then((data) => {
  (0,_modules_domFunctionality__WEBPACK_IMPORTED_MODULE_2__["default"])(data);
});
